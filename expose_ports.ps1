...
Write-Host "Adding Port Proxy for 3001..."
...
Write-Host "Adding Firewall Rule for 3001..."
New-NetFirewallRule -DisplayName "GlassKeep API 3001" -Direction Inbound -LocalPort 3001 -Protocol TCP -Action Allow -ErrorAction SilentlyContinue
