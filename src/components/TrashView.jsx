          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
            <div>
              ...
              <p className="text-gray-400 max-w-xl">
                ...
                You can restore them if you change your mind.
              </p>
            </div>
            ...
            {trashNotes.length > 0 && (
              <button
                ...
                className="px-5 py-2.5 bg-red-500/10 hover:bg-red-500/20 text-red-500 border border-red-500/20 rounded-xl transition-all flex items-center justify-center gap-2 font-semibold shadow-lg shadow-red-500/5 group"
              >
